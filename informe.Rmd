...
denspob <- datospob %>%  select(`Country Name`, `2018`) %>% rename(country = `Country Name`, denspob = `2018` )


faltan <- datos$country %in% denspob$country
datos$country[which(faltan == FALSE)]



denspob2 <-  recode(denspob$country, `Bahamas, The` = "Bahamas" )
```
