...
### Segundo análisis: Componentes principales

+ En este análisis empleamos las componentes principales obtenidas en el priemr proyecto como variables para agrupar las observaciones.
...
clust2 <- agnes(datos_acp, method = "ward", diss = FALSE, stand = TRUE)
```
...
clust2_nroclust <- indicadores(clust2$merge ,datos_acp ,10 )
