...
En la tabla anterior se presentan los valores de los cosenos al cuadrado de los ángulos que forman las observaciones con el primer plano principal, y la norma respecto al baricentro, ordenando las observaciones decrecientemente según esta última. Se aprecia que la observación con mayor norma (9,7) tiene una suma de cosenos al cuadrado de 0,43, por lo que se debe tener en cuenta que podría estar afectando el análisis, disminuyendo la inercia global explicada, porque su calidad de representación en el primer plano no es alta. Sin embargo, tras remover esta observación y observar que tiene poco efecto sobre el resultado del análisis y no representa una ganancia en inercia explicada, se opta por conservarla. El resto de observaciones con norma alta cuentan con valores de la cosenos al cuadrado superiores a 0,5 y en general mayores a 0,7 por lo que no les consideramos influyentes.
...
### Segundo Análisis (Creo que esto ya no iría)
...
```{r, include=TRUE, fig.cap="Gráfico de caja de las medidas de políticas fiscales adoptadas."}
boxplot.fiscal + ylab("Políticas fiscales adoptadas (% PBI)")
```
