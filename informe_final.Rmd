...
En la variable gdppercap hay bastante dispersión como es de esperarse y un conjunto pequeño de países con valores altos de la variable. Las observaciones que toman los mayores valores son Luxemburgo, Noruega y Suiza. 
...
acp <- PCA(datos[,vars.acp3], quanti.sup = 6)
```
